// ============================================================
// games/GameQuiz.jsx — เกมตอบคำถามรายวัน (Daily Quiz)
//
// หน้าที่: แสดงคำถาม 5-10 ข้อ → ผู้ใช้เลือกคำตอบ → รับคะแนน
//
// Flow:
//   1. GET /quiz/daily → โหลดคำถามวันนี้ (ถ้าทำแล้ววันนี้จะแสดง result)
//   2. ผู้ใช้ตอบทีละข้อ → สรุปคะแนนเมื่อครบ
//   3. POST /quiz/daily/complete → บันทึกผล + รับคะแนนสะสม
//
// คะแนน: ขึ้นอยู่กับจำนวนข้อที่ตอบถูก (แต่ละข้อมีคะแนนต่างกัน)
